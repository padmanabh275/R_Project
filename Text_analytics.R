...
reviews <- read_csv("C:/Users/admin/Documents/Kaggle_R/deceptive-opinion.csv")
...
## Now that we've given unsupervised topic modelling a go, let's try supervised topic modeling. For this, we're going to use something call TF-IDF
